...
***********************************************************************/
/*iterate through arr and push each element to duped array
function deepDup(arr, count = 0) {
  let duped = [];
  if (count === arr.length) return duped;//base case

  duped.push(arr[count]);

  return deepDup(arr, count + 1)//
}*/
